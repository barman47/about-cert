  ...
  <style>
    ...
    * {
    ...
    .resume .resume_left .resume_profile img {
      width: calc(var(--resume-left-width) * 0.8);
      height: calc(var(--resume-left-width) * 0.8);
      border-radius: 50%;
    ...
    .resume .resume_right ul li:last-child{
      margin-bottom: 0;
    }
